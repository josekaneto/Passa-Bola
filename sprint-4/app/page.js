...
export default function Home() {
  ...
  return (
    <>
      <section className="w-screen h-screen bg-center bg-no-repeat bg-cover bg-[url(/background1.png)] flex flex-col items-center relative font-corpo">
        <Header links={links} />
        <div
          className="w-full max-w-[80%] flex flex-col justify-start items-start absolute top-[55%] left-1/2 -translate-x-1/2 -translate-y-1/2 min-h-[400px]"
          data-aos="fade-up"
        ...
        >
          ...
          <h1 className="text-5xl font-bold font-title text-white mb-6 w-2/5" data-aos="fade-right" data-aos-delay="400">
            ELAS NO COMANDO: O FUTURO DO FUTEBOL COMEÇA AQUI
          </h1>
          <p className="text-lg text-white w-7/12" data-aos="fade-right" data-aos-delay="600">
          ...
          <Link
            href="/copasPab"
            className="mt-6 bg-purple text-white font-semibold px-5 py-3 rounded-xl hover:-translate-y-1 duration-300 transition-transform"
            data-aos="zoom-in"
            data-aos-delay="800"
          >
      ...
      <section className="w-full py-10 flex flex-col items-center">
        <h2 className="text-4xl font-bold font-title text-gray-800 mb-8" data-aos="fade-up" data-aos-duration="1000">
          Conheça as Vozes por Trás da Copa PAB
        </h2>
        <p className="text-center text-lg text-gray-700 max-w-2xl px-4 mb-10" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
      ...
      <section className="w-full bg-purple flex flex-col justify-center items-center px-4 text-center py-12">
        <h2 className="text-4xl font-bold text-white mb-8 font-title" data-aos="fade-up" data-aos-duration="1000">
          Junte-se a Nós na Jornada da Copa PAB!
        </h2>
        <p className="text-white max-w-2xl mb-8" data-aSejaos="fade-up" data-aos-duration="1000" data-aos-delay="200">
...
A Copa PAB é feita por e para vocês!
        ...
        <div className="flex justify-center mt-8 w-full">
          <Link
            href="/user/cadastro"
            className="bg-pink text-white font-bold px-8 py-4 rounded-xl shadow-lg"
            data-aos="fade-down"
